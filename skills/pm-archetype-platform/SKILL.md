...
- `../pm-phase-deliver/references/metric-quality-guardrails.md` — reliability + migration guardrails
- `../pm-transversal-stakeholder/` — consumer teams are critical stakeholders
