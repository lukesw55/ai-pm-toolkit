...
| 6 | PRD + Prototype + Refinement | `pm-phase-develop` | `pm-phase-develop/references/prd-writing.md` + `pm-phase-develop/references/prototyping-ladder.md` (prototype tier and loop) | `prds/<feature>.md` + prototype (tier recorded in `prototypes/<feature>.md`) | PRD approved, prototype validated at the chosen tier + mandatory pm-product-sense shadow evaluation (non-blocking; formal gate unchanged) |
