...
The stage-7 artefact this skill produces is the **Tech Team Kickoff** — see `references/tech-team-kickoff.md` for the 90-min agenda template (stage 7 of 8 in `../WORKFLOW.md`).
