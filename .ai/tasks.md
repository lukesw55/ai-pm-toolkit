...
- [x] Integrate the consolidated implementation after CI validation: PR #19 merged as `7650b2d` and PR #20 as `474ce87` (2026-09-10), PR #21 as `4929635` and PR #22 as `b51ddd3` (2026-09-14); rows in `docs/PR_HISTORY.md`. PR #23 stays open.
