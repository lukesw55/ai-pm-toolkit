...
The stage-2 artefact this skill commonly produces is the **Impact Brief** — see `references/impact-brief.md` for the template (stage 2 of 8 in `.claude/skills/WORKFLOW.md`).
