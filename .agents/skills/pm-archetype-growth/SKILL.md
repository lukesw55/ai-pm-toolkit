...
- `../pm-phase-define/references/kpi-tree.md` — growth trees cascade from North Star into funnel stages
- `../pm-phase-define/references/pricing-packaging.md` — monetisation is often growth territory
- `../pm-phase-develop/references/tracking-plan-design.md` — growth lives or dies on instrumentation
- `../pm-phase-deliver/references/experiment-interpretation.md` — daily reference
- `../pm-phase-deliver/references/metric-quality-guardrails.md` — second-daily reference
- `../pm-phase-deliver/references/product-analytics.md` — funnels, cohorts, retention
- `../pm-transversal-analysis/` — especially triangulation (why does the number move?)
